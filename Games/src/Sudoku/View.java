...
public class View extends JFrame implements KeyListener{
	...
	public void check() {
		...
		if(check == 81) {
			int answer = JOptionPane.showConfirmDialog(this, "Du hast das Sudoku gel�st! M�chtest du ein neues l�sen?", null, JOptionPane.YES_NO_OPTION);
			if(answer == 0)
			{
				reset();
			}
	...
	public void home() {
		this.setTitle("Kehre zur�ck zum Hauptmen�");
	}
